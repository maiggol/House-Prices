...
paramsForest = {'max_depth': [10], "n_estimators":[100]}

adaBoost = AdaBoostRegressor(random_state=0)
paramsAda = {"n_estimators":[100], "learning_rate":[2.5]}

gradientBoost = GradientBoostingRegressor(random_state=0, loss='huber', criterion="mse")
paramsGradient = {"learning_rate": [0.1], "n_estimators": [200], "max_depth": [3], "alpha":[.79]}

testModel = gradientBoost
testParams = paramsGradient
predModel = gradientBoost
...
predModel.set_params(max_depth=optParams["max_depth"], n_estimators=optParams["n_estimators"], alpha=optParams["alpha"])
...
solution.to_csv("../data/submissionGradientBoosting.csv", index = False)
